...
// checks if the IosysAgentDeviceSpecific type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IosysAgentDeviceSpecific{}
...
func (o IosysAgentDeviceSpecific) ToMap() (map[string]interface{}, error) {
