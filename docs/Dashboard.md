...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **int32** | The internal Id of dashboard | [optional] [readonly] 
...
**Sequence** | Pointer to **int32** | The sequence of the. If not defined, the sequence is automatically incremented. | [optional] 
