...
func (o *MbusAgentDeviceSpecific) GetAppResetSubcode() int32 {
	if o == nil || o.AppResetSubcode.Get() == nil {
		var ret int32
		return ret
	}
...
func (o *MbusAgentDeviceSpecific) GetMultiFrames() int32 {
	if o == nil || o.MultiFrames.Get() == nil {
		var ret int32
		return ret
	}
